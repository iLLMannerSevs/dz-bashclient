							...
							IF NOT EXIST "%%~dD%%~pD..\..\..\..\..\..\config.cpp" (
								IF NOT EXIST "%%~dD%%~pD..\..\..\..\..\..\..\config.cpp" (
									IF NOT EXIST "%%~dD%%~pD..\..\..\..\..\..\..\..\config.cpp" (
										...
										echo START /W "BinarizePBO" "%batchDirectory%/BinarizePBO.bat" %%D fuckThurston %compression% %shrink%
										START /W "BinarizePBO" "%batchDirectory%/BinarizePBO.bat" %%D fuckThurston %compression% %shrink%
									)
								)
							)
						)
