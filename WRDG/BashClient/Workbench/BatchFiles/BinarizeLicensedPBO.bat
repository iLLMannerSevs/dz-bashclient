...
echo LicensedModBuildDirectory is: "%modBuildDirectory%"
...
echo START /w %pboProject% %pboProject% +W -F +Stop -P -O +Z -E=dayz "%workDrive%!prefixName!" "+Mod=%workDrive%Temp\%modName%" "-Key"
START /w %pboProject% %pboProject% +W -F +Stop -P -O +Z -E=dayz "%workDrive%!prefixName!" "+Mod=%workDrive%Temp\%modName%" "-Key"
