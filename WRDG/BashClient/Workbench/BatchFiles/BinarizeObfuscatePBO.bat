...
echo START /w %pboProject% %pboProject% +W -F +Stop -P +O -E=dayz "%workDrive%!prefixName!" "+Mod=%workDrive%Temp\%modName%" "-Key"
START /w %pboProject% %pboProject% +W -F +Stop -P +O -E=dayz "%workDrive%!prefixName!" "+Mod=%workDrive%Temp\%modName%" "-Key"
